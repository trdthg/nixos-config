...
in pkgs.mkShell {
  buildInputs = with pkgs; [
    ...
    xorg.libXtst
    #android build
    (android-nixpkgs.sdk (sdkPkgs: with sdkPkgs; [ cmdline-tools-latest build-tools-32-0-0 tools patcher-v4 platform-tools platforms-android-31 system-images-android-31-default-x86-64 emulator ]))
    jdk8
    unzip
    #web build
    chromium
  ...
  #libepoxy workaround
  LD_LIBRARY_PATH = "${pkgs.libepoxy}/lib:${pkgs.gtk3.dev}/lib";
